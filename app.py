...
model = load_model('kilYeniSaved2.hdf5', custom_objects={'mean_squared_error_dice_loss': mean_squared_error_dice_loss,'dice_coef_loss': dice_coef_loss,'dice_coef': dice_coef})
modelsinif=load_model("BOLUTLU_SINIF.hdf5", custom_objects={'mean_squared_error_dice_loss': mean_squared_error_dice_loss,'dice_coef_loss': dice_coef_loss,'dice_coef': dice_coef}) 
...
def model_predict(img_path, model):
   ...
   cv2.imwrite('temp/sil.jpeg', one)   
   mask = cv2.imread('temp/sil.jpeg', 0)
   output1=cv2.inpaint(img2,mask,3,cv2.INPAINT_TELEA)
  
   cv2.imwrite('Rapor/son5.jpeg' ,output1)
   img=output1
